...
module.exports = {
   ...
   */
  recentSubmissions: 'http://localhost:1234/solr/search/select?sort=dc.date.accessioned_dt+desc&rows=5&q=location.%s:%s&fl=dc.title,dateIssued.year,handle&wt=json'
