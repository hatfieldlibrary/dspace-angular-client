...
(function () {
  ...
  module.exports = function (query, dspaceToken) {
     ...
     */
    var subjectFacets = 'http://localhost:1234/solr/search/select?facet=true&facet.mincount=1&facet.offset=0&version=2&rows=0&f.bi_4_dis_filter.facet.sort=index&f.bi_4_dis_filter.facet.limit=-1&fl=handle,search.resourcetype,search.resourceid&start=0&q=*:*&facet.field=bi_4_dis_filter&fq=NOT(withdrawn:true)&fq=NOT(discoverable:false)&wt=json%s';
