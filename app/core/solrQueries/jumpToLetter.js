...
(function () {
  ...
  module.exports = function (query, dspaceToken) {
     ...
     */
    var startLetterLocation = utils.getSolrUrl() + '/solr/search/select?fl=handle,search.resourcetype,search.resourceid&start=0&%s&wt=json&fq=NOT(withdrawn:true)&fq=NOT(discoverable:false)&fq=search.resourcetype:2%s&version=2&rows=0%s&%s';
