...
(function () {
  ...
  function DiscoverInnerCtrl($mdMedia,
                        $routeParams,
                        $location,
                        QueryManager,
                        AssetTypes,
    ...
    disc.selectedItem = $routeParams.selected;
    ...
    var initializeCallback = function() {
      ...
      if (disc.type === AssetTypes.COLLECTION) {
         ...
         */
        DiscoveryFormExtensions.getParentCommunityInfo(disc.collectionId);
  ...
  dspaceComponents.component('discoverInnerComponent', {

    templateUrl: ['AppContext', function (AppContext) {
      return '/' + AppContext.getApplicationPrefix() + '-app/app/templates/discover/discover-inner.html';
    }],
