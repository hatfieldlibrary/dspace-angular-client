...
The client supports login, logout, handle-based browsing of communities, collections and items, sorting, filtering, discovery, bitstream retrieval, and context-sensitive links to administration and submission options based on the user's authorization level.  No administrative UI modules currently exist. For this, the application is can be configured to use either xmlui or jspui UI administration. 
